...
<?php $company = \App\Company::find(auth()->user()->company_id); ?>
    ...
    <li >
        <a class="collapsible-header" href="{{url('/transporter')}}">
            <i class="fa fa-dashboard"></i> Dashboard
        </a>
    </li>
    <li><a class="collapsible-header" ><i class="fa fa-gear"></i> Manage Vehicle <span class="fa fa-chevron-down"></span></a>
        <ul class="collapsible-body">
            <li><a href="{{url('/transporter/vehicle/create')}}">Add new product</a></li>
            <li><a href="{{url('/transporter/vehicle')}}">my inventory</a></li>
        </ul>
    </li>
    <li><a class="collapsible-header" ><i class="fa fa-gear"></i> Manage Transportation <span class="fa fa-chevron-down"></span></a>
        <ul class="collapsible-body">
            <li><a href="{{url('/transporter/transportation/create')}}">Add Transportation</a></li>
            <li><a href="{{url('/transporter/transportation')}}">my transportations</a></li>
        </ul>
    </li>
    <li >
        <a class="collapsible-header" href="{{url('/transporter/get-customers-waiting-for-logistics')}}">
            <i class="fa fa-users"></i>Customers waiting for logistics
        </a>
    </li>
    <li >
        <a class="collapsible-header" href="{{url('/transporter/get-customers-waiting-for-logistics')}}">
            <i class="fa fa-gavel"></i>my winning bids
        </a>
    </li>
    <li >
        <a class="collapsible-header" href="{{url('/transporter')}}">
